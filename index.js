...
function getRandomFlavors(array1, array2, array3, array4){
  let combineArrays = array1.concat(array2, array3, array4);
  let randomFlavors = [];
  for (let i = 0; i < 31; i++) {
    let flavorChoice = Math.floor((Math.random()) * combineArrays.length);
    randomFlavors.push(combineArrays[flavorChoice]);
  } 
